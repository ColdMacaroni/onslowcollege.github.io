...
## Table of contents
- [Members and Properties](#members-and-properties)
...
- [Properties](#properties)
  - [What's in a property?](#whats-in-a-property)
    - [Step 1: Protect the variables](#step-1-protect-the-variables)
    - [Step 2: Getters and setters](#step-2-getters-and-setters)
      - [Getters](#getters)
      - [Setters](#setters)
- [Task](#task)
